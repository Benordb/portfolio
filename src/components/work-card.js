    ...
    <div className="flex flex-col sm:flex-row shadow-xl rounded-xl text-start overflow-hidden">
      ...
      >
        <div
          style={{
            backgroundImage:
              "url(https://res.cloudinary.com/dqhguhv7o/image/upload/v1723171041/samples/landscapes/architecture-signs.jpg)",
            backgroundSize: "cover",
            backgroundPosition: "center",
          }}
          className="rounded-lg w-full h-48 sm:h-96 bg-green-200"
        ></div>
      </div>
